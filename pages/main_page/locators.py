...
ADD_TO_CART_BTN = '[data-autotestid="card-add-to-basket-button"]'
CAROUSEL = '.products-carousel__item'
ADD_TO_CART_ICON = '[data-autotestid="ecomui-icon-plus"]'
DECREASE_ICON = '[data-autotestid="ecomui-icon-minus"]'
